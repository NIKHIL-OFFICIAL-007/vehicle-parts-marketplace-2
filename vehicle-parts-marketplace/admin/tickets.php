...
// Fetch all tickets with user info and sender role
$tickets = [];
try {
    $stmt = $pdo->prepare("
        SELECT t.id, t.subject, t.status, t.priority, t.created_at, t.sender_role,
...
<body class="bg-gray-50 text-gray-900">
  ...
  <div class="py-12 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <p class="text-blue-100 max-w-2xl mx-auto text-lg">View all customer and seller support requests.</p>
    </div>
  </div>
  ...
  <div class="container mx-auto px-6 py-8">
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
      <div class="p-6 border-b">
        ...
        <p class="text-gray-600 mt-1">Admins can view but cannot reply or update status.</p>
      </div>
