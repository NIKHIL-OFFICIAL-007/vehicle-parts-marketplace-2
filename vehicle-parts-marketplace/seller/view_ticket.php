...
try {
    // Fetch ticket - ensure it belongs to this seller
    $stmt = $pdo->prepare("
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reopen_ticket'])) {
    try {
        ...
        // Add system message
        $system_message = "Ticket reopened by seller.";
...
<body class="bg-gray-50 text-gray-900">
  ...
  <div class="py-12 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <p class="text-blue-100 max-w-2xl mx-auto text-lg">View and respond to this support request.</p>
    </div>
  </div>
          ...
          <div class="p-6 space-y-6">
            ...
            <?php if ($ticket['status'] === 'closed'): ?>
              ...
              <div class="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                ...
                <p class="text-gray-600">This ticket has been closed and cannot be reopened by the seller.</p>
              </div>
