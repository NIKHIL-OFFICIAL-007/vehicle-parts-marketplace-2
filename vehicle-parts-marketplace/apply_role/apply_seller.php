...
if ($has_seller && $user['role_status'] === 'approved') {
    header("Location: my_requests.php?message=already_approved");
    exit();
}

// Check if already has pending seller request
$has_pending = false;
if (isset($user['role_request']) && $user['role_request'] === 'seller' && $user['role_status'] === 'pending') {
    $has_pending = true;
}
...
if ($_POST) {
    ...
    try {
        // ✅ Preserve ALL existing roles and add 'seller'
        $new_roles = array_unique(array_merge($roles, ['seller']));
        ...
        $stmt = $pdo->prepare("
            ...
            WHERE id = ?
        ");
        $stmt->execute([$new_role, $reason, $additional_info, $user_id]);
  ...
  <div class="container mx-auto px-6 py-12 max-w-4xl">
    <div class="form-container">
      <div class="form-header text-center">
        <h1 class="text-2xl font-bold mb-2">Become a Verified Seller</h1>
        <p class="opacity-90">Join our marketplace and start selling auto parts to customers worldwide</p>
      </div>
      ...
      <form method="POST" class="form-body">
        ...
        <div class="form-step active" id="step1">
          <div class="mb-6">
            ...
            <p class="text-gray-600">Why do you want to be a seller?</p>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              class="form-textarea" 
              rows="4" 
              placeholder="Please explain why you want to sell auto parts on our platform..."
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              class="form-textarea" 
              rows="4" 
              placeholder="Share any relevant experience, qualifications, or business details..."
          ...
          <div class="bg-blue-50 p-4 rounded-lg border border-blue-100 mt-6">
            <h3 class="font-semibold text-blue-800 mb-2 flex items-center">
              <i class="fas fa-info-circle mr-2"></i> What we look for in sellers
            </h3>
            <ul class="feature-list">
              <li><i class="fas fa-check-circle"></i> Experience with auto parts or related industry</li>
              <li><i class="fas fa-check-circle"></i> Clear business plan or sourcing strategy</li>
              <li><i class="fas fa-check-circle"></i> Commitment to customer service</li>
              <li><i class="fas fa-check-circle"></i> Understanding of shipping and logistics</li>
            </ul>
          </div>
        ...
        <div class="form-step" id="step3">
          <div class="text-center py-8">
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-6">
              By submitting, you agree to our Seller Terms. Our team will contact you soon.
            </p>
